/**
 * Narrow published list payloads at the system boundary (pure).
 * Callers: encyclopedia infrastructure. Drops invalid rows; never throws.
 */
...
/**
 * Normalize one list row. Returns null when required fields or GCJ-02 coords are invalid.
 */
...
/** Normalize API array; non-arrays become []. */
